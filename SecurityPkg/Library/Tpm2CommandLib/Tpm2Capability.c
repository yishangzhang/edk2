  ...
  )
{
  ...
  UINT8 CONFIGDATA[] = {0x80, 0x01, 0x00, 0x00, 0x00, 0x2B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x04, 0x00, 0x04, 0x03, 0xFF, 0xFF, 0xFF, 0x00, 0x0B, 0x03, 0xFF, 0xFF, 0xFF, 0x00, 0x0C, 0x03, 0xFF, 0xFF, 0xFF, 0x00, 0x0D, 0x03, 0xFF, 0xFF, 0xFF};
  CopyMem(&RecvBuffer, CONFIGDATA, sizeof(CONFIGDATA));
  Status= EFI_SUCCESS;
  if (EFI_ERROR (Status)) {
    return Status;
  }
